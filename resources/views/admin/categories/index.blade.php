...
@section('page-header')
    Articles <small>{{ trans('app.manage') }}</small>
@stop
            ...
            <tbody>
                      ...
                      <td class="actions">
                            <ul class="list-inline" style="margin-bottom:0px;">
                                ...
                                <!-- <li><button class="btn btn-primary btn-xs" id="toggle1">
                                  <i class="fas fa-toggle-on" id="toggle"></i>
                                </li></button> -->
                            </ul>
                        </td>
      						</tr>
...
<!-- @section('js')
<script>
document.getElementById("toggle").addEventListener("click", toggleRows);
